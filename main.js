...
if (
  ...
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de AutoCAD 2020 - Projeto Civil</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/T6RdEWLdyO8" title="Aula demonstrativa do curso de AutoCAD Projeto Civil - Rocket Academy" alt="Videoaula sobre Autocad Projeto Civil" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><p class="license_cgd">Cursos gravados e desenvolvidos pela CGD &copy;</p> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"> <li>Ajustes e manipulação de círculo e retângulo</li> <li>Perspectiva isométrica</li> <li>Projeção ortogonal</li> <li>Casos especiais de cotagem e projeção</li> <li>Cortes</li> <li>Layout e impressão</li> </ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">10 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">4 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">24 horas </div> </div> </div> </div></section>'
}
...
if (
  ...
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de SketchUp 2020 - Avançado</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/ytkjVuulrbQ" title="Aula demonstrativa do curso de SketchUp Avançado - Rocket Academy" alt="Videoaula sobre SketchUp Avançado" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><p class="license_cgd">Cursos gravados e desenvolvidos pela CGD &copy;</p> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"> <li>Modelagem de terreno</li> <li>Animações</li> <li>Photomatching</li> <li>SketchUp Layout e documentação</li> <li>Modelagem de móveis</li> <li>Preparação de render</li> </ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">7 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">2 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">6 horas </div> </div> </div> </div></section>'
}

// ESPECIALISTA EM EXCEL
if (
  window.location.href === 'https://rocketacademyschool.com.br/curso/excel-365'
) {
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de Excel 365</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/gDqz8nsVBy4" title="Aula demonstrativa do curso de Excel 365 - Rocket Academy" alt="Videoaula sobre Excel" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><p class="license_cgd">Cursos gravados e desenvolvidos pela CGD &copy;</p> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"><li>Conhecendo o Excel 365</li><li>Formatando as colunas</li><li>Selecionando células, linhas e colunas</li><li>Copiando e colando células</li><li>Fórmulas básicas: adição e subtração</li><li>Fórmulas básicas: multiplicação, divisão e função SOMA</li><li>Fórmulas básicas: ordem de precedência e exponenciação (potência)</li><li>Formatando a planilha: mesclando células, alterando alinhamento e fonte</li><li>Formatando a planilha: aplicando efeitos no texto, formatando números e unidades monetárias</li><li>Calculando desconto e acréscimo com porcentagem</li><li>Referência relativa, absoluta e auditoria de fórmulas</li><li>Praticando as referências relativa e absoluta</li><li>Ajustando células e AUTOSOMA</li><li>Excluindo linhas e colunas</li><li>Funções MÁXIMO, MÍNIMO e MÉDIA</li><li>Classificando dados e função SE</li><li>Gerenciando várias planilhas: copiando dados entre planilhas</li><li>Gerenciando várias planilhas: criando planilhas</li><li>Gerenciando várias planilhas: movendo, ocultando, reexibindo e criando links entre tabelas</li><li>Usando minigráficos</li><li>Função CONT.SE</li><li>Configurando página no Excel</li><li>Criando e formatando gráficos</li><li>Formatação condicional</li><li>Função SOMASE e comentários em células</li><li>Usando a função PROCV</li></ul><div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">26 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">3 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">21 horas </div> </div> </div> </div></section>'
}

if (
  window.location.href ===
  'https://rocketacademyschool.com.br/curso/excel-365-avancado'
) {
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de Excel Avançado 365</h1> <div class="video_curso"><iframe width="1271" height="715" src="https://www.youtube.com/embed/JpKbZRwAqPw" title="Aula demonstrativa do curso de Excel Avançado 365 - Rocket Academy" alt="Videoaula sobre Excel Avançado" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><p class="license_cgd">Cursos gravados e desenvolvidos pela CGD &copy;</p> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"><li>Macros: primeiro contato</li><li>Macros: utilizando variáveis e inputboxes</li><li>Macros: atribuindo macros à botões</li><li>Projetos com macros</li><li>Manipulando planilhas</li><li>Usando a função SOMASE</li><li>Conferindo resultados com autofiltro</li><li>Inserindo links entre tabelas</li><li>Usando a função PROCV e CONT.SE: importando dados</li><li>Usando a função PROCV e CONT.SE: formatando os dados</li><li>Usando a função CORRESP e ÍNDICE</li><li>Tabela dinâmica: criando e formatando uma tabela dinâmica</li><li>Tabela dinâmica: criando uma tabela dinâmica e definindo um novo intervalo</li><li>Tabela dinâmica: desagrupando dados e visualizando detalhes de um campo agrupado</li><li>Gráfico dinâmico: criando o gráfico dinâmico</li><li>Gráfico dinâmico: alterando o layout e formatando o gráfico</li><li>Copiando dados para outra planilha</li><li>Trabalhando com controles de formulário</li><li>Implementando a macro ATUALIZARMES</li><li>Totalizando o acumulado dos meses</li><li>Usando funções de data</li><li>Usando a função FIMMÊS</li><li>Usando a função DIATRABALHO</li><li>Usando a função CONVERTER</li><li>Solver</li></ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">30 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">4 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">20 horas </div> </div> </div> </div></section>'
}

if (
  window.location.href ===
  'https://rocketacademyschool.com.br/curso/excel-365-dashboard'
) {
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de Excel Dashboard 365</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/2CCevYQMScw" title="Aula demonstrativa do curso de Excel Dashboard 365 - Rocket Academy" alt="Videoaula sobre Excel Dashboard" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><p class="license_cgd">Cursos gravados e desenvolvidos pela CGD &copy;</p> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"><li>Criando um modelo de dados</li><li>Selecionando dinamicamente os dados</li><li>Usando KPIs (key performance indicators)</li><li>Dashboard completo</li><li>Usando minigráficos</li><li>Gráfico de termômetro</li><li>Usando botões de opção e macros</li><li>Usando caixa de combinação</li><li>Barra de rolagem e função DESLOC</li><li>Gráfico de velocímetro</li><li>Gráfico de marcador ou de bala</li><li>Segmentação de dados e linha do tempo</li></ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">16 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">2 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">14 horas </div> </div> </div> </div></section>'
}

if (
  window.location.href ===
  'https://rocketacademyschool.com.br/curso/excel-365-tabelas-dinamicas'
) {
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de Excel Tabelas Dinâmicas 365</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/jAYNRsrKNvQ" title="Aula demonstrativa do curso de Excel Tabela Dinamica 365 - Rocket Academy" alt="Videoaula sobre Excel Tabelas Dinamicas" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><p class="license_cgd">Cursos gravados e desenvolvidos pela CGD &copy;</p> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"><li>Importar e manipular arquivos de texto</li> <li>Atualizando dados importados</li> <li>Remover vínculos da planilha</li> <li>Criando tabelas</li> <li>Filtrando tabelas</li> <li>Segmentação de dados</li> <li>Importar um banco de dados do Microsoft Access</li> <li>Relacionando campos com a função PROCV</li> <li>Criando tabela dinâmica</li> <li>Combinando campos</li> <li>Seções da tabela dinâmica: linhas e valores</li> <li>Seções da tabela dinâmica: filtros e colunas</li> <li>Combinando campos</li> <li>Mostrar detalhes</li> <li>Classificar dados</li> <li>Complementando o exemplo da universidade</li> <li>Agrupamento de dados</li> <li>Tipos de dados</li> <li>Trabalhando com totalizações</li> <li>Segmentação de dados</li> <li>Linha do tempo</li> <li>Agrupar campos e modificar o layout do relatório</li> <li>Inserindo gráfico dinâmico</li> <li>Formatando o gráfico dinâmico</li></ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">24 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">2 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">13 horas </div> </div> </div> </div></section>'
}
...
if (
  ...
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de Windows 11</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/ySf2gj9SBgc" title="Aula demonstrativa do curso de Windows 11 - Rocket Academy" alt="Videoaula sobre Windows 11" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"> <li>Conhecendo o Windows</li> <li>Recursos especiais do Windows</li> <li>Criando e personalizando atalhos</li> <li>Excluindo e restaurando arquivos da lixeira</li> <li>Paint: desenhando e criando formas</li> <li>Paint: copiando, colando e criando textos</li> <li>WordPad: digitando e formatando textos</li> <li>WordPad: opções localizar, substituir e inserir</li> <li>Calculadora padrão e as operações básicas</li> <li>Calculadora científica e os conversores de unidades</li> <li>Navegando com o Microsoft Edge</li> <li>Relógio e calendário</li> <li>Sticky notes e bloco de notas</li> <li>Explorador de arquivos: abertura, layout do programa e seleção</li> <li>Explorador de arquivos: abrindo e excluindo arquivos</li> <li>Explorador de arquivos: copiando e colando arquivos</li> <li>Explorador de arquivos: recortando e movendo arquivos</li> <li>Explorador de arquivos: classificação de arquivos</li> <li>Explorador de arquivos: personalizando a barra de classificação</li> <li>Explorador de arquivos: utilizando a barra de pesquisa</li> <li>Conhecendo as pastas pessoais</li> <li>Adicionar, remover e criar bibliotecas</li> <li>Configurações do Windows: sistema</li> <li>Configurações do Windows: personalização</li> <li>Configurações do Windows: aplicativos</li> <li>Configurações do Windows: contas</li> <li>O disco rígido e as unidades locais</li> <li>Manutenção básica do Windows</li> <li>Compactando arquivos com o Windows e com o WinRAR</li> <li>Segurança do Windows e antivírus</li> </ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">30 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">4 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">16 horas </div> </div> </div> </div></section>'
}
...
if (
  ...
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de Word 365</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/6eziYJn-GSY" title="Aula demonstrativa do curso de Word 365 - Rocket Academy" alt="Videoaula sobre Word" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"> <li>Conhecendo o Word 365</li> <li>Criando documentos e digitando textos</li> <li>Seleção de textos</li> <li>Formatação de textos</li> <li>Parágrafo e alinhamento</li> <li>Espaçamento entre linhas e recuos de parágrafos</li> <li>Estilos de texto</li> <li>Verificação ortográfica e gramatical</li> <li>Tradução e leitura em voz alta</li> <li>Ferramentas de aprendizagem</li> <li>Listas numeradas e com marcadores</li> <li>Definindo e formatando tabulação</li> <li>Folha de rosto e estilos</li> <li>Personalizando cabeçalho e rodapé</li> <li>Tabelas: inserindo e selecionando tabelas</li> <li>Tabelas: inserindo e ajustando novas linhas e colunas</li> <li>Tabelas: classificando dados e formatando a planilha</li> <li>Bordas em parágrafos e textos</li> <li>Bordas nas páginas e sombreamento</li> <li>Configurações de página</li> <li>Mala direta: iniciando a mala direta</li> <li>Mala direta: inserindo campos e concluindo a mala direta</li> <li>Localizar e substituir textos</li> <li>Utilizando imagens</li> <li>Criando WordArts</li> <li>Criando gráficos</li> <li>Criando formas</li> <li>Trabalhando com texto em colunas e letras capitulares</li> <li>Criando SmartArts</li> <li>Utilizando modelos 3D em seus documentos</li> </ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">30 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">3 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">21 horas </div> </div> </div> </div></section>'
}

//DESIGNER GRAFICO
if (
  window.location.href ===
  'https://rocketacademyschool.com.br/curso/illustrator-2022'
) {
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de Illustator 2022</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/61yJ-m3Wp_Q" title="Aula demonstrativa do curso de Illustrator 2022 - Rocket Academy" alt="Videoaula de Illustrator" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"><li>Conhecendo o Illustrator</li><li>Preenchimento e traçado</li><li>Ferramenta tipo</li><li>Manipulação de textos</li><li>Seleção de similares</li><li>Linhas guias e importação de arquivos</li><li>Trabalhando com vetores</li><li>Cartão de visita e ajuste da prancheta</li><li>Interação entre objetos vetoriais</li><li>Trabalhando com camadas</li><li>Processo de vetorização</li><li>Ferramenta caneta</li><li>Conversão em traçado</li><li>Símbolos</li><li>Biblioteca de pincéis e estilos de texto</li><li>Ferramenta malha</li><li>Projeto completo (logotipo e cartão de visita)</li><li>Ferramenta de perspectiva</li><li>Efeito de fumaça</li><li>Compartilhamento de documento</li><li>Preparação de arquivos para impressão</li></ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">22 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">3 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">21 horas </div> </div> </div> </div></section>'
}
if (
  window.location.href ===
  'https://rocketacademyschool.com.br/curso/coreldraw-2021'
) {
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de CorelDRAW 2021</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/hJ3lnhWx1Bw" title="Aula demonstrativa do curso de CorelDRAW 2021 - Rocket Academy" alt="Videoaula de CorelDraw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"><li>Conhecendo o programa</li><li>Ferramentas de formas básicas</li><li>Controles de objetos</li><li>Preenchimentos</li><li>Desenhar em perspectiva</li><li>Trabalhar com textos</li><li>Ações entre objetos</li><li>Tabelas</li><li>Ferramentas de desenho</li><li>Painel objetos</li><li>Efeitos de lente</li><li>Vista de várias páginas</li><li>Recortes e substituição de cores</li><li>Exportar arquivos</li><li>Configurações e impressões</li></ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">22 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">4 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">12 horas </div> </div> </div> </div></section>'
}
if (
  window.location.href ===
  'https://rocketacademyschool.com.br/curso/3ds-max-2019'
) {
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"> <h1 class="titulo_video">Conheça a nossa primeira aula de 3DS Max 2019</h1> <div class="video_curso"><iframe src="https://www.youtube.com/embed/wgVMLxtHaHM" title="Aula demonstrativa do curso de 3DS Max - Rocket Academy" alt="Videoaula de 3DS Max" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div> <h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"><li>Primeiro contato com o 3ds Max</li><li>Os eixos e as funções do mouse no 3ds Max</li><li>O painel de comandos do 3DS Max</li><li>A guia criar, geometria e formas</li><li>As ferramentas de seleção e seus gizmos</li><li>Modelagem de polígonos básica</li><li>A ferramenta linha e o modificador limpar</li><li>Os diferentes tipos de snaps</li><li>A ferramenta matriz</li><li>Criando uma bola de futebol com modificadores</li><li>A ferramenta proboolean e o modificador simetria</li><li>Extrusão em spline e a suavização de malha</li><li>O primeiro contato com os materiais</li><li>Outros ajustes de materiais</li><li>Câmeras</li><li>Renderizando com câmeras</li><li>Ajustes com câmeras</li><li>Iluminação</li><li>Ajustes de iluminação</li></ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">29 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">2 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">18 horas </div> </div> </div> </div></section>'
}
// END DESIGNER GRAFICO
// END DOS VIDEOS INDIVIDUAIS DE CADA CURSO //
if (
  window.location.href === 'https://rocketacademyschool.com.br/como-funciona'
) {
  document.getElementsByClassName('document__content typography')[0].outerHTML =
    '<div class="document__content typography"> <h4>Aprenda com Conteúdo de Qualidade</h4> <p>Aprender é uma jornada eterna e para ajudá-lo nessa jornada, nós criamos uma plataforma interativa, acessada através do "Portal do Aluno". Com a plataforma, você terá acesso a todas as vídeo aulas, apostilas e um passo a passo detalhado de como realizar os exercícios do curso escolhido. Além disso, você poderá fazer anotações direto na plataforma, o que vai auxiliar na sua aprendizagem.</p> <h4>Aprenda de Forma Prática e Interativa</h4> <p>Nossa plataforma foi criada pensando em você, para que o processo de aprendizagem seja o mais simples e eficiente possível. Com as vídeo aulas, você terá acesso a conteúdo de qualidade, ensinado por instrutores especializados e capacitados. Além disso, você poderá tirar todas as suas dúvidas através da nossa plataforma, já que os instrutores estarão sempre disponíveis para ajudá-lo.</p> <br> <div class="video_curso"><iframe src="https://www.youtube.com/embed/8-ipCq88VPM" title="Como funciona a plataforma da Rocket Academy School" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div> <br> <h4>Passo a Passo para Realizar Exercícios</h4> <p>Não importa se você é iniciante ou já tem conhecimento sobre o assunto, nós fornecemos um passo a passo detalhado para realizar os exercícios do curso. Dessa forma, você poderá praticar o que aprendeu e ter a certeza de que está evoluindo no seu aprendizado.</p> <h4>Anote Tudo o que Você Aprender</h4> <p>Ao longo do processo de aprendizagem, é comum que surjam dúvidas e ideias que você queira anotar para não esquecer. Por isso, na nossa plataforma, você poderá fazer anotações direto na plataforma, o que vai facilitar a sua vida e garantir que você não perca nenhum detalhe importante.</p> <h4>Certificado de Conclusão de Curso</h4> <p>Ao finalizar o curso escolhido em nossa plataforma interativa, o estudante receberá uma certificação válida e reconhecida pelo mercado, comprovando sua capacidade e conhecimento adquirido ao longo do curso. Conclua o seu curso conosco e receba a sua certificação de conclusão de curso.</p></div>'
}
