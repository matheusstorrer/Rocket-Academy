...
if (
  ...
  document.getElementsByClassName('product-tabs')[0].innerHTML =
    '<section class="section_video_curso"><h1 class="titulo_video">Conheça a nossa primeira aula de Marketing Pessoal</h1> <div class="video_curso"><video src="https://example.com/video.mp4" controls></video> </div><h1 class="cont_programatico">Conteúdo Programático</h1> <div class="cont_duration"> <ul class="lista_cont_programatico"> <li>Introdução</li> <li>O Que É Marketing Pessoal?</li> <li>Importância Do Marketing Pessoal E As Competências Fundamentais</li> <li>Como Fazer Um Projeto De Vida</li> <li>Como Fazer Marca Pessoal</li> <li>Exercício De Autoconhecimento</li> <li>Estratégias De Marketing Pessoal</li> <li>Como Fazer Comunicação Assertiva</li> <li>Apresentação Pessoal</li> <li>Estabelecer Relações Verdadeiras</li> <li>Crie, Aprimore E Mantenha Sua Rede Contatos</li> <li>Benchmarking De Pessoas</li> <li>Autoimagem Positiva E Otimista</li> <li>Etiqueta Corporativa</li> <li>Etiqueta Na Internet</li> </ul> <div class="spec__section"> <div class="spec__row"> <div class="spec__name">Quantidade de aulas </div> <div class="spec__value">16 aulas </div> </div> <div class="spec__row"> <div class="spec__name">Horas de videoaula </div> <div class="spec__value">2 horas </div> </div> <div class="spec__row"> <div class="spec__name">Horas em projetos </div> <div class="spec__value">7 horas </div> </div> </div> </div></section>'
}
